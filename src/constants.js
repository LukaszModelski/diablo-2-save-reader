...
const ITEM_DATABASE = {
  ...
  'mbl': { name: 'Mesh Boots', type: 'Boots' },
  'vbt': { name: 'Vigor Boots / Heavy Boots', type: 'Boots' },
  'tbt': { name: 'Heavy Boots', type: 'Boots' },
  'lbt': { name: 'Leather Boots', type: 'Boots' },
  'vgl': { name: 'Venom Grip / Heavy Gloves', type: 'Gloves' },
  'lgl': { name: 'Leather Gloves', type: 'Gloves' },
  'hbl': { name: 'Heavy Belt', type: 'Belt' },
  'lbl': { name: 'Leather Belt', type: 'Belt' },
  'xrs': { name: 'Guilded Shield / Dragon Shield', type: 'Shield' },
  ...
  '8s8': { name: 'Gothic Bow (Exceptional)', type: 'Bow' },
